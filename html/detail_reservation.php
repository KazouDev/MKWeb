    ...
    <div class="wrapper">
        ...
        <main class="main__container">
                ...
                <div class="detail-reservation__contenu">
                    ...
                    <div class="hote">
                        ...
                        <div class="section2__article3">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d8544.925581204967!2d-2.5527066852125144!3d48.586915081517375!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x480e0e90a5504f43%3A0x40ca5cd36e62fc0!2s22370%20Pl%C3%A9neuf-Val-Andr%C3%A9!5e0!3m2!1sfr!2sfr!4v1715792791097!5m2!1sfr!2sfr"
                        ...
                        <div class="section3__informationoccupation">
                            <div class="informationoccupation__detail">
                                <div>
                                    ...
                                    <p><?= (new DateTime($verifAssociation["date_debut"]))->format('d/m/Y') ?>
                                    <p>
                                </div>
                    ...
                    <div class="detail-reservation__section4">
                        ...
                        <div class="partiemontant">
                            ...
                            <div class="montantFinal">
                                ...
                                <p class="texteGras">
                                    <?= $verifAssociation["prix_ttc"] + $verifAssociation["taxe_commission"] + $taxeSejour ?>
                                    €</p>
                            </div>
                    ...
                    <div class="detail-reservation__section5">
                        ...
                        <p>Veuillez noter que ce montant total n'inclut pas les suppléments (par exemple, les lits
                            d'appoint).</p>
                        <br>
                        <p>En cas de non-présentation ou d'annulation, une partie du montant est retenu si le délai de
                            prévenance fixé par le vendeur dans les <a href="" class="couleur">conditions
                                d’annulation</a> n’est pas respecté (le montant retenu peut être l’intégralité de la
                            somme prépayée). Le montant non retenu est reversé immédiatement.</p>
                    </div>
                </div>
            ...
            <div class="telecharger">
                ...
                <p>La version imprimable de votre confirmation contient toutes les informations importantes de votre
                    réservation. Elle peut être utilisée lors de de votre arrivée dans le logement. <br><br> Pour la
                    télécharger, <a href="" class="couleur"> cliquez ici.</a></p>
            </div>
        </main>
